...
function Services() {
  return (
    <div className="flex items-center justify-center h-full dark:bg-dot-white/[0.2] bg-dot-black/[0.2] flex-col mt-10">
      <div className="flex flex-col items-center justify-center">
        <h3 className="text-4xl m-5 font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 font-serif mt-20 text-center">
          WHY CHOOSE US
        </h3>
        ...
        <p className="text-center font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 font-serif max-w-[70%]">
  ...
  development.
        ...
        {/* <p className="text-center font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 font-serif max-w-[70%] md:hidden">
          Discover effortless website creation with us. Craft a standout online
          presence effortlessly, no matter your technical background. Our tools
          and templates empower your unique vision seamlessly. Elevate your
          digital identity and engage your audience with ease, sans traditional
