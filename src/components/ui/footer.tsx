    ...
    <div>
      <footer className="bg-gradient-to-r from-gray-100 via-[#bce1ff] to-gray-100">
        <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              ...
              <p className="max-w-xs mt-4 text-sm text-gray-600">
                At SIGH, our team crafts custom websites, Android apps, and
                innovative machine learning projects. We turn your ideas into
                reality with precision and creativity, tailored to your unique
                needs.
              </p>
              <div className="flex mt-8 space-x-6 text-gray-600">
                ...
                <a
                  href="https://x.com/SighQuestcrew"
                  className="hover:opacity-75"
                  target="_blank"
                  rel="noreferrer"
                >
            ...
            <div className="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <div>
                ...
                <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
                  <a className="hover:opacity-75"> Android Development </a>
                  <a className="hover:opacity-75"> Web Development </a>
                  <a className="hover:opacity-75"> Machine learning </a>
                  <a className="hover:opacity-75"> Documentation Management </a>
                </nav>
              </div>
              <div>
          ...
          <p className="mt-8 text-xs text-gray-800">© 2024 Sigh-Quest-Crew</p>
        </div>
      </footer>
    </div>
  );
